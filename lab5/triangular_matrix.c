...
{
	/*
	 * In order to avoid concurrency occured by variables visibility, we declared everything in the scope of the 'for' and thus, directly in the scope of the thread. 
	 */
